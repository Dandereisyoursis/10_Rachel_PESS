				...
				<form action="update.php" method="post">
					<?php
						if ($car != null) {
							...
							echo "<label for='patrolCarId' class='col-1g-4 col-form-label'>Patrol Car's Number</label>";
							echo "<div class='col-1g-8'>";
							echo $car['id'];
							...
							echo "<div class='form-group row'>";
							echo "<label for='patrolCarId' class='col-1g-4 col-form-label'>Patrol Car's Status</label>";
							echo "<div class='col-1g-8'>";
